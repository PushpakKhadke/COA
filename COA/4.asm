; 8086 Assembly Language Program for Multiplication of two 8-bit HEX numbers using NEAR Procedure.

;JOURNAL PROGRAM

;Multiplication of two 8-bit hex numbers using NEAR procedure
